# YAML parsing and implementation of regionprops based single-cell quantification
...
from miaaim.quant import quantificaton
...
def RunQuantificationYAML(pars):
    ...
    il = quantificaton.HDIquantification(**yml["ImportOptions"])
